...
//                   {/* Icon with animation */}
//                   <motion.div 
//                     className="bg-white p-4 rounded-full mb-4 group-hover:bg-cyan-400/30 transition-colors"
//                     variants={iconVariants}
//                     initial="hidden"
//                     animate={mobileCardsAnimation.isInView ? "visible" : "hidden"}
//                   >
//                     <div className="text-black text-left">{feature.icon}</div>
//                   </motion.div>
...
//               <motion.div 
//                 key={index} 
//                 className={`flex flex-col items-start bg-white backdrop-blur-md rounded-xl p-6 md:p-8 text-center border border-neutral-200 shadow-lg hover:shadow-xl transition-all duration-500`}
//               >
//                 {/* Icon with animation */}
//                 <motion.div 
